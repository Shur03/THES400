  ...
  return (
    ...
    >
      ...
      {formData.type === "uvs" ? (
        ...
        <FormGroup className="mb-4">
          <FormLabel className="font-semibold">Жин (кг)</FormLabel>
          <FormControl
            className="mx-5"
            type="number"
            name="weight"
      ...
      {/* Purchase Date */}
      <FormGroup className="mb-4">
        <FormLabel className="font-semibold">Худалдан авсан огноо</FormLabel>
        <FormControl
          type="date"
          name="buy_date"
          value={formData.buy_date}
          placeholder="Худалдан авсан огноо"
          onChange={handleChange}
          required
        />
      </FormGroup>
      ...
      {/* Price */}
      <FormGroup className="mb-4">
        <FormLabel className="font-semibold">Нийт үнэ</FormLabel>
        <FormControl
          className="mx-5"
          type="number"
          name="price"
          value={formData.price}
          placeholder="худалдан авсан үнээ оруулна уу"
          onChange={handleChange}
          required
        />
      </FormGroup>
